...
For more efficient real-time applications, use GPIO interrupts instead of polling:
...
Enables GPIO interrupts for data ready detection. This is more efficient than polling.

- `callback`: Function called from ISR when data is ready
